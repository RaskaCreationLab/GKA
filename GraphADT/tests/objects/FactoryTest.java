...
public class FactoryTest {
	...
	public void testImportG() {
		...
		try{
			...
			test.add("#gerichtet");
			test.add("vertex1,vertex2,50,10"); //teste mit richtiger datei mit attributen
			
			testNames.add("kosten");
			testNames.add("weg");
			...
			*/
			...
			Graph g = Factory.importCreateG(test, testNames);
			...
			g = Factory.importCreateG(test, testNames);
			assertEquals(2, g.getVertexes().size());
			assertEquals(2, g.getEdges().size());
			...
			assertEquals(null, Factory.importCreateG(test, testNames));
